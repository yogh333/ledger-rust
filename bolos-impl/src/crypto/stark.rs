...
impl<const B: usize> SecretKey<B> {
    ...
    fn generate_into(&self, out: &mut MaybeUninit<cx_ecfp_private_key_t>) -> Result<(), Error> {
        ...
        sk_data = [0x04,0xa2,0xc3,0x81,0x1d,0x30,0xda,0xef,0x56,0xd3,0x02,0x5a,0xb2,0x76,0xeb,0xe6,0xbd,0xfc,0x70,0xa8,0xfc,0x0b,0xf2,0x2e,0x9b,0x83,0x98,0xaf,0x59,0x54,0xd8,0xef];
